...
This is a **pilot batch** — a slice of a much larger Drive library, pulled
first to prove the path end to end. Two things to know about the rest of
that library before it gets pulled through:
